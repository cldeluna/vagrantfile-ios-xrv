...
# From: https://github.com/ios-xr/vagrant-xrdocs/blob/master/simple-mixed-topo/Vagrantfile
...
Vagrant.configure(2) do |config|
    ...
    config.vm.define "devbox" do |node|
      ...
      node.vm.network :private_network, virtualbox__intnet: "link2", ip: "192.168.99.100"
